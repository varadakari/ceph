...
static const uint64_t dev_size = 5368709120ULL;

#define BLUEFS_START 1048576

string get_temp_bdev()
{
  static int n = 0;
...
// TODO:: modified to false
// Need to create memtable_factory with skipLists
...
class StressTest {
 public:
  ...
  void createfs() {
    device = get_temp_bdev();
    uuid_d fsid;
    fs->add_block_device(BlueFS::BDEV_DB, device);
 ...
 private:
  ...
  void Open() {
    ...
    options_.info_log.reset(create_rocksdb_ceph_logger());
